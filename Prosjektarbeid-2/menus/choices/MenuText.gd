...
const CHOICE_HEAD_1 = "Turn on location sharing to get this upgrade"
...
const INFO_HEAD_1 = "Before you decide, check out these awesome benefits you get from keeping it on"
